...
ABOUT THIS PROGRAM
//////////////////////////////////////////////////////////////////////////////////////
'pseudoScheduler' is a program that simulates how an operating system caches pages in memory. Its purpose is to showcase various page-replacement algorithms. Ideally, you want to access the hard drive just once per page, but with a limited number of frames in which to place the pages, we have to determine where to put that page in memory. It takes command-line input for an input file and algorithm selection; currently available algorithms in this software are First-In-First-Out, Least-Recently Used, and Optimal.
